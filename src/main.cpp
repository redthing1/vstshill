...
int main(int argc, char* argv[]) {
  ...
  // command parsers
  args::Command inspect_cmd(commands, "inspect", "inspect and analyze a vst3 plugin", &vstk::cmd_inspect);
  args::Command gui_cmd(commands, "gui", "open plugin editor gui window", &vstk::cmd_gui);
  args::Command process_cmd(commands, "process", "process audio files through plugin", &vstk::cmd_process);
  args::Command scan_cmd(commands, "scan", "scan for vst3 plugins in standard directories", &vstk::cmd_scan);
  args::Command parameters_cmd(commands, "parameters", "analyze and list plugin parameters", &vstk::cmd_parameters);
