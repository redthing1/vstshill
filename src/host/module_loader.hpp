...
enum class LoadingStage {
  ...
  POST_SYMBOL_RESOLVE,  // after symbol resolution, before calling entry functions
...
// handles platform-specific loading of VST3 bundles, retrieves the IPluginFactory,
// and ensures the library is unloaded when the object is destroyed
class VstModule {
public:
